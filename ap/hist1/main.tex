...
\subsection[Chronologie]{Chronologie}
\frame{
...
\frame{
	...
	\begin{enumerate}
		\item Magnavox Odyssey (1972) -> Nintendo Color TV Game (1980)
		\item Fairchild Channel F (1976) -> Krach du jeux vidéo de 1983 -> Atari 2600 (1992)
		\item Post Krach de 83 NES (1983) -> Nintendo Famicom (2003)
		\item NEC PC-Engine (1987) -> SNK Neo Geo (2004)
		\item 3DO Interactive Multiplayer (1993) -> Sony PSOne (2005)
		\item Sega Dreamcast (1998) -> Sony PS2 (2013)
		\item XBox 360 (2005) -> ...
		\item Wii U (2012) -> ...
	\end{enumerate}
	\begin{center}
